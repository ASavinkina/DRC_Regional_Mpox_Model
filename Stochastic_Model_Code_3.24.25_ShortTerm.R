...
# Model code with no aging or deaths/births: meant for short-term runs (less than 1 year)
...
params <- list(
  ...
  aging = c(0,0),#c(1/(5*365),1/(10*365)),#c(1/20, 1/30),  # Aging rates from young to adult and adult to senior
  demog= demog,
  movement = movement,
